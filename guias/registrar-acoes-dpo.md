...
task: registrar-acoes-dpo
role: encarregado
routes: ["#/dpo-actions", "#/dpo-actions/report"]
screenshots: [blgpd-dpo-02-form]
...
> ⚠️ O módulo **ajuda** a demonstrar o trabalho do encarregado, mas **não** garante conformidade nem substitui assessoria jurídica. Veja o [Aviso legal](/disclaimer/).
