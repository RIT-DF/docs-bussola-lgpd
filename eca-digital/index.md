...
>
> O terceiro setor é um dos públicos **mais alcançados** por essa lei, porque muitas OSCs trabalham diretamente com crianças e adolescentes. O Bússola LGPD ajuda você a descobrir **se** e **em que medida** a lei se aplica ao seu caso, e a cumprir os deveres certos — sem virar um sistema de verificação de identidade.
...
## O que o Bússola LGPD oferece para o ECA Digital

| Tema | Onde no produto |
|---|---|
| Descobrir se a lei te alcança | [Enquadramento (Mapa de Conformidade)](/eca-digital/enquadramento/) |
| Consentimento dos pais para dados de menores | [Consentimento parental](/eca-digital/consentimento-parental/) |
| Tratar os dados no nível mais protetivo | [Privacidade por padrão](/eca-digital/privacidade-por-padrao/) |
| Avaliar riscos do tratamento (RIPD) | [Módulo RIPD](/modulos/ripd/) |
