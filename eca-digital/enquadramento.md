---
title: "Descobrir se a lei te alcança (enquadramento)"
nav_order: 1
parent: "ECA Digital (Lei 15.211/2025)"
permalink: /eca-digital/enquadramento/
role: encarregado
routes: ["#/mapa"]
screenshots: [eca-01, eca-02]
...
O Bússola tem uma **triagem de enquadramento** dentro do **Mapa de Conformidade**. Você responde poucas perguntas e o sistema mostra **apenas os deveres que se aplicam ao seu caso** — sem encher a tela de obrigações que não são suas.
...
<!-- screenshot: eca-02 — deveres aplicáveis acesos após a triagem -->
