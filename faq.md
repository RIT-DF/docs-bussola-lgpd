...
## Preciso contratar um advogado para usar o Bússola LGPD?
...
Sim. O Bússola LGPD trata políticas de forma genérica: crie quantas precisar (Privacidade, Termos de Uso, Cookies, e outras). Só a Política de Privacidade tem um checklist específico. Veja [Políticas](/modulos/politicas/).
...
## Uso Google Forms. O Bússola cobre eles também?

Sim. No Verificador, use **+ Adicionar Google Form** (cole a URL pública — o Bússola lê os campos sozinho, sem login na sua conta Google) ou **🔍 Procurar no site** (ele varre as páginas e acha os que você incorporou/linkou). A partir daí o Google Form é **verificado** e pode **entrar no Inventário (ROPA)** como qualquer outro. Duas ressalvas importantes: (1) a **retenção/expurgo automático não cobre** Google Forms — os dados ficam no Google e a exclusão é feita lá; (2) o Bússola lê só a **estrutura** do formulário, **nunca as respostas**. Se ele não conseguir ler um formulário (privado, por exemplo), você informa os campos à mão. Detalhes em [Formulários do Google](/modulos/formularios/#formulários-do-google-google-forms).
